...
This is the readme for ZtroHub, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. ZtroHub) > Ok.
...
- To run the project find ZtroHub.java (which will be in under src/main/java/ztrohub) and right click > Run 'ZtroHub'
